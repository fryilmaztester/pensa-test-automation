 ...
 */
export declare function Then_I_see_local_storage_item(key: string): void;
/**
 ...
 */
export declare function Then_I_see_local_storage_item_equals(key: string, value: string): void;
/**
 ...
 * - {@link Then_I_see_local_storage_item | Then I see local storage item}
 */
export declare function Then_I_see_local_storage_item_contains(key: string, value: string): void;
/**
 ...
 * - {@link Then_I_see_local_storage_item | Then I see local storage item}
 */
export declare function Then_I_do_not_see_local_storage_item(key: string): void;
