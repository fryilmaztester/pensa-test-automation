 ...
 */
export declare function Then_I_see_element_is_visible(options?: DataTable): void;
/**
 ...
 */
export declare function Then_I_see_element_is_not_visible(options?: DataTable): void;
