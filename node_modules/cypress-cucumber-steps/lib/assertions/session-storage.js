...
exports.Then_I_do_not_see_session_storage_item = exports.Then_I_see_session_storage_item_contains = exports.Then_I_see_session_storage_item_equals = exports.Then_I_see_session_storage_item = void 0;
 ...
 */
function Then_I_see_session_storage_item(key) {
...
(0, cypress_cucumber_preprocessor_1.Then)('I see session storage item {string}', Then_I_see_session_storage_item);
/**
 ...
 */
function Then_I_see_session_storage_item_equals(key, value) {
    cy.wrap({}).should(function () {
...
(0, cypress_cucumber_preprocessor_1.Then)('I see session storage item {string} equals {string}', Then_I_see_session_storage_item_equals);
/**
 ...
 * - {@link Then_I_see_session_storage_item | Then I see session storage item}
 */
function Then_I_see_session_storage_item_contains(key, value) {
    cy.wrap({}).should(function () {
...
(0, cypress_cucumber_preprocessor_1.Then)('I see session storage item {string} contains {string}', Then_I_see_session_storage_item_contains);
/**
 ...
 * - {@link Then_I_see_session_storage_item | Then I see session storage item}
 */
function Then_I_do_not_see_session_storage_item(key) {
    cy.wrap({}).should(function () {
...
(0, cypress_cucumber_preprocessor_1.Then)('I do not see session storage item {string}', Then_I_do_not_see_session_storage_item);
