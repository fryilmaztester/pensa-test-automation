 ...
 */
export declare function When_I_double_click(options?: DataTable): void;
/**
 ...
 */
export declare function When_I_double_click_position(position: 'top' | 'left' | 'center' | 'right' | 'bottom' | 'bottom-left' | 'bottom-right' | 'top-left' | 'top-right', options?: DataTable): void;
/**
 ...
 */
export declare function When_I_double_click_on_text(text: string, options?: DataTable): void;
