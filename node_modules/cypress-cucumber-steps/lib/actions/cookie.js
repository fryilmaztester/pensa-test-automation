...
exports.When_I_set_cookie = exports.When_I_clear_cookie = void 0;
 ...
 */
function When_I_clear_cookie(name, options) {
    cy.clearCookie(name, (0, utils_1.getOptions)(options));
}
exports.When_I_clear_cookie = When_I_clear_cookie;
 ...
 */
function When_I_set_cookie(name, value, options) {
    cy.setCookie(name, value, (0, utils_1.getOptions)(options));
}
exports.When_I_set_cookie = When_I_set_cookie;
(0, cypress_cucumber_preprocessor_1.When)('I set cookie {string} to {string}', When_I_set_cookie);
