 ...
 */
export declare function When_I_intercept_URL(url: string, routeMatcher?: DataTable): void;
/**
 ...
 */
export declare function When_I_intercept_URL_and_stub_body(url: string, body: string): void;
