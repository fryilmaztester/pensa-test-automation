...
exports.When_I_set_local_storage_item = exports.When_I_clear_all_local_storage = exports.When_I_clear_local_storage = void 0;
 ...
 */
function When_I_clear_local_storage(key) {
    cy.clearLocalStorage(key);
}
exports.When_I_clear_local_storage = When_I_clear_local_storage;
(0, cypress_cucumber_preprocessor_1.When)('I clear local storage', When_I_clear_local_storage);
(0, cypress_cucumber_preprocessor_1.When)('I clear local storage {string}', When_I_clear_local_storage);
/**
 ...
 */
function When_I_clear_all_local_storage() {
    cy.clearAllLocalStorage();
}
exports.When_I_clear_all_local_storage = When_I_clear_all_local_storage;
(0, cypress_cucumber_preprocessor_1.When)('I clear all local storage', When_I_clear_all_local_storage);
/**
 ...
 * - {@link When_I_clear_local_storage | When I clear local storage}
 */
function When_I_set_local_storage_item(key, value) {
    cy.wrap({}).then(function () {
        localStorage.setItem(key, value);
    });
}
exports.When_I_set_local_storage_item = When_I_set_local_storage_item;
(0, cypress_cucumber_preprocessor_1.When)('I set local storage item {string} to {string}', When_I_set_local_storage_item);
