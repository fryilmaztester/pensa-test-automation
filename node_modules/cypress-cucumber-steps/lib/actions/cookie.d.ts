 ...
 */
export declare function When_I_clear_cookie(name: string, options?: DataTable): void;
/**
 * When I set cookie:
 *
 * ```gherkin
 ...
 */
export declare function When_I_set_cookie(name: string, value: string, options?: DataTable): void;
