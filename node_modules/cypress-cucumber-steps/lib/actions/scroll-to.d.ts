 ...
 */
export declare function When_I_scroll_window_to_position(position: 'top' | 'left' | 'center' | 'right' | 'bottom' | 'bottom-left' | 'bottom-right' | 'top-left' | 'top-right', options?: DataTable): void;
/**
 ...
 */
export declare function When_I_scroll_window_to_x_y_coordinates(x: number, y: number, options?: DataTable): void;
/**
 ...
 */
export declare function When_I_scroll_to_position(position: 'top' | 'left' | 'center' | 'right' | 'bottom' | 'bottom-left' | 'bottom-right' | 'top-left' | 'top-right', options?: DataTable): void;
/**
 ...
 */
export declare function When_I_scroll_to_x_y_coordinates(x: number, y: number, options?: DataTable): void;
