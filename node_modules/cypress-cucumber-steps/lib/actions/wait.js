...
exports.When_I_wait_milliseconds = exports.When_I_wait_seconds = void 0;
 ...
 */
function When_I_wait_seconds(seconds) {
    When_I_wait_milliseconds(seconds * 1000);
}
exports.When_I_wait_seconds = When_I_wait_seconds;
(0, cypress_cucumber_preprocessor_1.When)('I wait {int} seconds', When_I_wait_seconds);
(0, cypress_cucumber_preprocessor_1.When)('I wait {int} second', When_I_wait_seconds);
/**
 ...
 */
function When_I_wait_milliseconds(milliseconds) {
    cy.wait(milliseconds);
}
exports.When_I_wait_milliseconds = When_I_wait_milliseconds;
(0, cypress_cucumber_preprocessor_1.When)('I wait {int} milliseconds', When_I_wait_milliseconds);
(0, cypress_cucumber_preprocessor_1.When)('I wait {int} millisecond', When_I_wait_milliseconds);
