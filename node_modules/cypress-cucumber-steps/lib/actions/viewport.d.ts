 ...
 */
export declare function When_I_set_viewport(preset: 'ipad-2' | 'ipad-mini' | 'iphone-3' | 'iphone-4' | 'iphone-5' | 'iphone-6' | 'iphone-6+' | 'iphone-7' | 'iphone-8' | 'iphone-x' | 'iphone-xr' | 'iphone-se2' | 'macbook-11' | 'macbook-13' | 'macbook-15' | 'macbook-16' | 'samsung-note9' | 'samsung-s10', orientation?: 'portrait' | 'landscape'): void;
/**
 ...
 */
export declare function When_I_set_viewport_width_height(width: number, height: number): void;
