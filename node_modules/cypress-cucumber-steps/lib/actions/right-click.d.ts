 ...
 */
export declare function When_I_right_click(options?: DataTable): void;
/**
 ...
 */
export declare function When_I_right_click_position(position: 'top' | 'left' | 'center' | 'right' | 'bottom' | 'bottom-left' | 'bottom-right' | 'top-left' | 'top-right', options?: DataTable): void;
/**
 ...
 */
export declare function When_I_right_click_on_text(text: string, options?: DataTable): void;
//# sourceMappingURL=right-click.d.ts.map