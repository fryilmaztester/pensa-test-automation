 ...
 */
export declare function When_I_find_headings_by_text(text: string, options?: DataTable): void;
/**
 ...
 */
export declare function When_I_find_heading_by_text(text: string, options?: DataTable): void;
