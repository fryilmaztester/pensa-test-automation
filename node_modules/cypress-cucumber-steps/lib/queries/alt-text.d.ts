 ...
 */
export declare function When_I_find_elements_by_alt_text(altText: string): void;
/**
 ...
 */
export declare function When_I_find_element_by_alt_text(altText: string): void;
/**
 ...
 * - {@link When_I_find_image_by_alt_text | When I find image by alt text}
 */
export declare function When_I_find_images_by_alt_text(altText: string): void;
/**
 ...
 * - {@link When_I_find_images_by_alt_text | When I find images by alt text}
 */
export declare function When_I_find_image_by_alt_text(altText: string): void;
